...
//   "use strict";
      ...
      ? (
        ...
        ? function () {
            for (var t = arguments.length, s = new Array(t), n = 0; n < t; n++)
              s[n] = arguments[n];
            return e.apply(P(this), s), O(E.get(this));
          }
        : function () {
            for (var t = arguments.length, s = new Array(t), n = 0; n < t; n++)
              s[n] = arguments[n];
            return O(e.apply(P(this), s));
          }
      : function (t) {
          for (
            var s = arguments.length, n = new Array(s > 1 ? s - 1 : 0), r = 1;
          ...
          return D.set(a, t.sort ? t.sort() : [t]), O(a);
        };
  }
  function N(e) {
  ...
  function O(e) {
    ...
    const t = N(e);
    return t !== e && (q.set(e, t), U.set(t, e)), t;
  }
  const P = (e) => U.get(e);
  ...
  T = ((e) =>
    R(
      ...
      {},
      {
        get: (t, s, n) => M(t, s) || e.get(t, s, n),
        has: (t, s) => !!M(t, s) || e.has(t, s),
      }
    ))(T);
  s(229);
  ...
  class W {
    ...
    async setTimestamp(e, t) {
      const s = {
        ...
        n = (await this.getDb()).transaction(A, "readwrite", {
          durability: "relaxed",
        });
    ...
    async expireEntries(e, t) {
      ...
      const i = [];
      for (const o of r) await s.delete(A, o.id), i.push(o.url);
      return i;
    }
    _getId(e) {
  ...
  let ne;
  const re = () => (
    ne || ((ne = new se()), ne.addFetchListener(), ne.addCacheListener()), ne
  );
  function ae(e, t, s) {
    let n;
    if ("string" === typeof e) {
    ...
    } else if (e instanceof RegExp) n = new te(e, t, s);
    else if ("function" === typeof e) n = new ee(e, t, s);
    else {
      if (!(e instanceof ee))
  ...
  self.addEventListener("activate", () => self.clients.claim()),
    (function (e) {
      ...
      { revision: "2d96c497a5cf88ec91b186fe90aa6659", url: "/index.html" },
      { revision: null, url: "/static/css/main.01db12a8.css" },
      { revision: null, url: "/static/js/422.8b16a534.chunk.js" },
      { revision: null, url: "/static/js/main.480c17d1.js" },
      { revision: null, url: "/static/media/E-com.652bd011f280ef9ca665.png" },
      {
        revision: null,
        url: "/static/media/Fullstack_Developer_Resume.4deceb65a09c275c69e9.pdf",
      },
      { revision: null, url: "/static/media/Taskify.c01e7b8573bcb4475ea3.png" },
      { revision: null, url: "/static/media/about.aee0f771fbfc1e7b8fa8.png" },
      {
        revision: null,
        url: "/static/media/artisteeA.3e9d3b9199f7ec4549cd.png",
      },
      {
        revision: null,
        url: "/static/media/artisteeF.1f84ada010a095c0c39c.png",
      },
      {
        revision: "3c9241c2d284b85346b0c8e719568989",
        url: "static/media/Gemini_Generated_Image_hkgf3fhkgf3fhkgf.png",
      },
      {
        revision: null,
        url: "/static/media/easy-code.d399bb77712bb35103b7.png",
      },
      {
        revision: "1aed08b3e1b66991d921d25dbdcf28ed",
        url: "/static/media/home-main.541f8179af8209ce03ccf2178fe62dbf.svg",
      },
      {
        revision: null,
        url: "/static/media/jsomBlog.94e64b2da457909bf52d.png",
      },
    ]),
    (function (e) {
      const t = Y();
  ...
  }, ((le = "/index.html"), Y().createHandlerBoundToURL(le))),
    ae(
      (e) => {
        let { url: t } = e;
